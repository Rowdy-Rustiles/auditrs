/*
    Definition of an Audit Event. This corresponds to the audit events emitted by the kernel,
    which may contain multiple fields.
...
impl RawAuditEvent {
    pub fn new(_type: RawEventType, data: String) -> Self {
        RawAuditEvent {
            record_type: _type,
            data,
        }
...
impl From<RawEventType> for u16 {
    fn from(value: RawEventType) -> Self {
        use RawEventType::*;
...
pub mod test {
    ...
    fn test_record_to_log() {
        let record_type = RawEventType::from(1300); // Syscall
        ...
        assert_eq!(num, 1300);
        assert_eq!(RawEventType::from(num), record_type);
    }
}
